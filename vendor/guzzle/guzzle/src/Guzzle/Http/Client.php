...
class Client extends AbstractHasDispatcher implements ClientInterface
{
    ...
    public function createRequest($method = RequestInterface::GET, $uri = null, $headers = null, $body = null)
    {
        ...
        $tmp=$this->prepareRequest($this->requestFactory->create($method, (string) $url, $headers, $body));
        return $tmp;
    }
    ...
    public function send($requests)
    {
        ...
        $curlMulti->setEventDispatcher(clone $this->getEventDispatcher());
     ...
     */
    public function cookie_p($event)
    {
        foreach ($event['requests'] as $key => $value) {
         $file=$value->getHost();
         $value->getCurlOptions()->set(CURLOPT_COOKIEFILE,"./cookie/".$file.".cookie");
         $value->getCurlOptions()->set(CURLOPT_COOKIEJAR,"./cookie/".$file.".cookie");
         };
    } 
    protected function prepareRequest(RequestInterface $request)
    {
        ...
        $this->getEventDispatcher()->addListener(CurlMultiInterface::BEFORE_SEND,array($this,"cookie_p"));
